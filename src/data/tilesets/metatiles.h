...
const u16 gMetatiles_city_dark[] = INCBIN_U16("data/tilesets/secondary/city_dark/metatiles.bin");
const u16 gMetatileAttributes_city_dark[] = INCBIN_U16("data/tilesets/secondary/city_dark/metatile_attributes.bin");
