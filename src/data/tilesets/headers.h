...
const struct Tileset gTileset_city_dark =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_city_dark,
    .palettes = gTilesetPalettes_city_dark,
    .metatiles = gMetatiles_city_dark,
    .metatileAttributes = gMetatileAttributes_city_dark,
    .callback = NULL,
};
